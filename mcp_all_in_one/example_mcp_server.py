"""
The code contains all the tools and prompts for the MCP server.
...
- draw_rectangle: Draw a rectangle in Paint from (x1,y1) to (x2,y2)
- draw_rectangle_and_text: Draw a rectangle and add text in Paint
- open_paint: Open Microsoft Paint maximized on secondary monitor
